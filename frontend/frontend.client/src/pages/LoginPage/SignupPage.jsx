...
export default function SignupPage() {
  ...
  const loginWithGitHub = () => {
    window.location.href = `${API_BASE}/Auth/external/GitHub`;
  };
  ...
  const validateAll = () => {
    ...
    if (userRole === "candidate") {
      ...
      if (!hasAnyLink) {
        setFieldError(
          "websiteUrl",
          "Provide at least one link (Website, LinkedIn, or Instagram)."
        );
        ok = false;
      } else {
        setFieldError("websiteUrl", "");
    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/Auth/register`, {
        ...
        body: JSON.stringify({
          ...
          fullName: userRole === "candidate" ? fullName : null,
          ...
          <div className="lp-left">
            ...
            <div className="lp-left-inner">
              ...
              <motion.p
                ...
                className="lp-desc"
              >
                Create your account and start matching with opportunities based
                on skills, interests, and experience.
              </motion.p>
            ...
            <div className="lp-left-wide">
              <div className="lp-signup-note" role="note" aria-live="polite">
                <div>
                  {userRole === "recruiter" ? (
                    <>
                      <div className="lp-signup-note-title">
                        What happens next?
                      </div>
                      <div className="lp-signup-note-text">
                        We’ll email you a confirmation and submit your
                        organization for admin review. Once approved, you’ll be
                        able to post jobs and manage applications.
                      </div>
                      <div className="lp-signup-note-subtle">
                        Approval is usually quick. You’ll get an email once it’s
                        done.
                      </div>
                    </>
                  ) : (
                    <>
                      ...
                      <div className="lp-signup-note-text">
                        After signing up, we’ll assess your profile to improve
                        matching and recommendations. You can start exploring
                        opportunities right away.
                      </div>
                      <div className="lp-signup-note-subtle">
                        Your data is used only to enhance your Jobify
                        experience.
                      </div>
                    </>
                  )}
              ...
              >
                <div className="lp-roletoggle">
                  <div className="lp-roletoggle-wrap">
                    <button
                      ...
                      className={`lp-rolebtn ${
                        userRole === "candidate" ? "lp-rolebtn--active" : ""
                      }`}
                    >
                      Candidate
                    </button>
                    <button
                      ...
                      className={`lp-rolebtn ${
                        userRole === "recruiter" ? "lp-rolebtn--active" : ""
                      }`}
                    >
                      Recruiter
                    </button>
                ...
                <form onSubmit={handleSubmit} className="lp-form">
                    ...
                    <div className="lp-field">
                      ...
                      <div className="lp-password">
                        <input
                          id="fullName"
                          className={`lp-input ${
                            errors.fullName ? "lp-input--error" : ""
                          }`}
                          type="text"
                          value={fullName}
                      ...
                      {errors.fullName && (
                        <div className="lp-error">{errors.fullName}</div>
                      )}
                    </div>
                  ) : (
                    <>
                      <div className="lp-field">
                        ...
                        <div className="lp-password">
                          <input
                            id="companyName"
                            className={`lp-input ${
                              errors.companyName ? "lp-input--error" : ""
                            }`}
                            type="text"
                            value={companyName}
                        ...
                        {errors.companyName && (
                          <div className="lp-error">{errors.companyName}</div>
                        )}
                      </div>
                      ...
                      <div className="lp-field">
                        ...
                        <input
                          id="websiteUrl"
                          className={`lp-input ${
                            errors.websiteUrl ? "lp-input--error" : ""
                          }`}
                          type="url"
                          value={websiteUrl}
                        ...
                        {errors.websiteUrl && (
                          <div className="lp-error">{errors.websiteUrl}</div>
                        )}
                      </div>
                    </>
                  )}
                  ...
                  <div className="lp-field">
                    ...
                    {errors.email && (
                      <div className="lp-error">{errors.email}</div>
                    )}
                  </div>
                    ...
                    <div className="lp-password">
                      <input
                        ...
                        className={`lp-input lp-input--padright ${
                          errors.password ? "lp-input--error" : ""
                        }`}
