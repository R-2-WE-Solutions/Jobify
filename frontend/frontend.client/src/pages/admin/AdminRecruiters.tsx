...
export default function AdminRecruiters() {
    ...
    const colors = {
        pageBg: darkMode ? "#0f172a" : "#f9fafb",
        cardBg: darkMode ? "#1e293b" : "#ffffff",
        cardBgSoft: darkMode ? "#111827" : "#f9fafb",
        text: darkMode ? "#f8fafc" : "#111827",
        muted: darkMode ? "#cbd5e1" : "#6b7280",
        border: darkMode ? "#334155" : "#e5e7eb",
        inputBg: darkMode ? "#0f172a" : "#ffffff",
        inputText: darkMode ? "#f8fafc" : "#111827",
        tableHead: darkMode ? "#111827" : "#f9fafb",
        hover: darkMode ? "#263449" : "#f9fafb",
        badgeBg: darkMode ? "#334155" : "#f3f4f6",
        badgeText: darkMode ? "#e5e7eb" : "#374151",
    };
    ...
    return (
        <div className="admin-page" style={{ backgroundColor: colors.pageBg, color: colors.text }}>
            <div
                style={{
