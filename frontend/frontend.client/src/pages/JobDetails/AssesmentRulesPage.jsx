    ...
    useEffect(() => {
        const load = async () => {
            ...
            try {
                ...
                const questions = opp?.assessment?.questions ?? attempt?.assessment?.questions ?? [];
                ...
                const chFromQuestions = Array.isArray(questions)
                    ? questions.filter(q => q?.type === "code" || q?.type === "design").length
                    : null;
                ...
                setRulesData({
                    timeLimitSeconds:
                        ...
                        opp?.assessment?.timeLimitSeconds ??
                        null,

                    mcqCount:
                        attempt?.mcqCount ??
                        opp?.assessmentMcqCount ??         
                        mcqFromQuestions ??
                        null,

                    challengeCount:
                        attempt?.challengeCount ??
                        opp?.assessmentChallengeCount ??    
                        chFromQuestions ??
                        null,
                });
            } catch (e) {
                ...
                <section className="rulesCard">
                    ...
                    <label className="checkRow">
                        ...
                        <div>
                            ...
                            <div className="checkSub">
                                Webcam snapshots will be taken every 2–3 minutes during the assessment.
                            </div>
                        </div>
                    </label>
                    ...
                    <label className="checkRow">
                        ...
                        <div>
                            ...
                            <div className="checkSub">
                                I understand the timer cannot be paused and unusual behavior may be flagged.
                            </div>
                        </div>
                    </label>
                </section>
