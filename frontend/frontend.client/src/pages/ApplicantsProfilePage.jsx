...
export default function ApplicantProfilePage() {
    ...
    return (
      <div className="applicant-profile-page">
        <div className="applicant-profile-container">
          <div className="applicant-loading-card">Loading...</div>
        </div>
      </div>
    );
  }
  ...
  if (!data) {
    return (
      <div className="applicant-profile-page">
        <div className="applicant-profile-container">
          <div className="applicant-empty-card">Could not load applicant profile.</div>
        </div>
      </div>
    );
  }
      ...
      <div className="applicant-profile-container">
        ...
        <div className="applicant-hero">
          ...
          <div className="applicant-hero-stats-row">
            <div className="applicant-hero-stat applicant-hero-stat-accent">
        ...
        <div className="applicant-sections">
          ...
          <div className="applicant-section">
            ...
            <div className="applicant-section-subtitle">Academic background</div>
              ...
              {education.length > 0 ? (
                education.map((e, i) => (
                  <div className="applicant-entry-card" key={i}>
                    ...
                    {e.gpa ? (
                      <div className="applicant-entry-card-text">GPA: {e.gpa}</div>
                    ) : null}
                  </div>
                ))
              ) : (
                    ...
                    {splitTechStack(p.techStack).length > 0 ? (
                      <div className="applicant-tags">
                        {splitTechStack(p.techStack).map((tag, idx) => (
                          <span key={idx} className="applicant-tag">
                            {tag}
                          </span>
                        ))}
                      </div>
            ...
            {interests.length > 0 ? (
              <div className="applicant-interest-bubbles">
                {interests.map((interest, idx) => (
                  <span key={idx} className="applicant-interest-bubble">
                    {interest}
                  </span>
                ))}
              </div>
          ...
          <div className="applicant-section">
            ...
            <div className="applicant-entry-list">
              ...
              <div className="applicant-entry-card">
                <div className="applicant-entry-card-title">Certifications</div>
                <div className="applicant-entry-card-text">
